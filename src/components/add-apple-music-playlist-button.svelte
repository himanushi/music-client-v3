...
import AddedAppleMusicPlaylistMessage from "~/components/toast-messages/added-apple-music-playlist-message.svelte";
...
$: if ($service.matches("done")) {
  ...
  toasts.open({
    component: AddedAppleMusicPlaylistMessage,
    type: "info"
  });
