...
export type SelectPlaylistsQuery = {
  readonly playlists: ReadonlyArray<Pick<Playlist, "id" | "name">>;
};
...
export const SelectPlaylistsDocument: DocumentNode<
  SelectPlaylistsQuery,
  SelectPlaylistsQueryVariables
> = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SelectPlaylists" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
export const SpotifyLoginDocument: DocumentNode<
  SpotifyLoginQuery,
  SpotifyLoginQueryVariables
> = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SpotifyLogin" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
export const SpotifyLogoutDocument: DocumentNode<
  SpotifyLogoutQuery,
  SpotifyLogoutQueryVariables
> = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SpotifyLogout" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
