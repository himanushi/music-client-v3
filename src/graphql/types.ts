...
export type AlbumQuery = { readonly album?: Maybe<(
    ...
    & { readonly artworkL: Pick<Artwork, 'url' | 'width' | 'height'>, readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicAlbum?: Maybe<Pick<AppleMusicAlbum, 'id' | 'appleMusicId'>>, readonly itunesAlbum?: Maybe<Pick<AppleMusicAlbum, 'id' | 'appleMusicId'>>, readonly spotifyAlbum?: Maybe<Pick<SpotifyAlbum, 'id' | 'spotifyId'>>, readonly tracks: ReadonlyArray<(
      ...
      & { readonly artworkL: Pick<Artwork, 'url' | 'width' | 'height'>, readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicTracks?: Maybe<ReadonlyArray<Pick<AppleMusicTrack, 'id' | 'name' | 'appleMusicId'>>>, readonly spotifyTracks?: Maybe<ReadonlyArray<Pick<SpotifyTrack, 'id' | 'name' | 'spotifyId'>>> }
    )> }
  )> };
