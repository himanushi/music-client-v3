...
export type ChangeFavoritesMutation = { readonly changeFavorites?: Maybe<{ readonly currentUser?: Maybe<(
...
export type LoginMutation = { readonly login?: Maybe<(
    Pick<LoginPayload, 'error'>
    & { readonly currentUser?: Maybe<(
      Pick<CurrentUser, 'id' | 'name' | 'username' | 'registered' | 'version'>
      & { readonly publicInformations: ReadonlyArray<Pick<PublicInformation, 'id' | 'publicType'>>, readonly role: Pick<Role, 'id' | 'name' | 'description' | 'allowedActions'>, readonly favorite: Pick<Favorite, 'albumIds' | 'artistIds' | 'trackIds'> }
    )> }
  )> };
...
export type MeQuery = { readonly me: (
    Pick<CurrentUser, 'id' | 'name' | 'username' | 'registered' | 'version'>
    & { readonly publicInformations: ReadonlyArray<Pick<PublicInformation, 'id' | 'publicType'>>, readonly role: Pick<Role, 'id' | 'name' | 'description' | 'allowedActions'>, readonly favorite: Pick<Favorite, 'albumIds' | 'artistIds' | 'trackIds' | 'playlistIds'> }
  ) };
