...
export type AddPlaylistItemsMutation = { readonly addPlaylistItems?: Maybe<{ readonly playlist?: Maybe<Pick<Playlist, 'id' | 'name'>> }> };
...
export type UpsertPlaylistMutation = { readonly upsertPlaylist?: Maybe<{ readonly playlist?: Maybe<(
      Pick<Playlist, 'id' | 'name' | 'description' | 'publicType' | 'createdAt' | 'updatedAt'>
      & { readonly author?: Maybe<Pick<User, 'id' | 'name' | 'username'>>, readonly track?: Maybe<(
        Pick<Track, 'name'>
