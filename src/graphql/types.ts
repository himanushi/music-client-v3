...
export type Mutation = {
  ...
  /** 全プレイリストの人気を集計する */
  readonly tallyPlaylists?: Maybe<TallyPlaylistsPayload>;
...
export type Mutation_TallyPlaylistsArgs = {
  input: TallyPlaylistsInput;
};
...
/** Autogenerated input type of TallyPlaylists */
export type TallyPlaylistsInput = {
  /** A unique identifier for the client performing the mutation. */
  readonly clientMutationId?: Maybe<Scalars['String']>;
};

/** Autogenerated return type of TallyPlaylists */
export type TallyPlaylistsPayload = {
  /** A unique identifier for the client performing the mutation. */
  readonly clientMutationId?: Maybe<Scalars['String']>;
  readonly error?: Maybe<Scalars['String']>;
  readonly result?: Maybe<Scalars['String']>;
...
export const SpotifyLoginDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SpotifyLogin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"code"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spotifyLogin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"code"},"value":{"kind":"Variable","name":{"kind":"Name","value":"code"}}}]}]}}]} as unknown as DocumentNode<SpotifyLoginQuery, SpotifyLoginQueryVariables>;
export const SpotifyLogoutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SpotifyLogout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spotifyLogout"}}]}}]} as unknown as DocumentNode<SpotifyLogoutQuery, SpotifyLogoutQueryVariables>;
