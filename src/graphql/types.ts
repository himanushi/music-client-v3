...
export type AlbumsQuery = { readonly albums: ReadonlyArray<(
...
export type ArtistsQuery = { readonly artists: ReadonlyArray<(
...
export type PlaylistsQuery = { readonly playlists: ReadonlyArray<(
