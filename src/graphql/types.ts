...
export type Query_SpotifyLoginArgs = {
...
export type AddPlaylistItemsMutation = { readonly addPlaylistItems?: Maybe<(
...
export type LogoutMutation = { readonly logout?: Maybe<(
    Pick<LogoutPayload, 'error'>
    & { readonly currentUser?: Maybe<CurrentUserFieldsFragment> }
  )> };
...
export type UpsertPlaylistMutation = { readonly upsertPlaylist?: Maybe<(
    Pick<UpsertPlaylistPayload, 'error'>
    & { readonly playlist?: Maybe<(
      Pick<Playlist, 'id' | 'name' | 'description' | 'publicType' | 'createdAt' | 'updatedAt'>
      & { readonly author?: Maybe<Pick<User, 'name' | 'username'>>, readonly track?: Maybe<(
        Pick<Track, 'name'>
...
export type AlbumQuery = { readonly album?: Maybe<(
    ...
    & { readonly artworkL: Pick<Artwork, 'url' | 'width' | 'height'>, readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicAlbum?: Maybe<Pick<AppleMusicAlbum, 'id' | 'appleMusicId'>>, readonly itunesAlbum?: Maybe<Pick<AppleMusicAlbum, 'id' | 'appleMusicId'>>, readonly spotifyAlbum?: Maybe<Pick<SpotifyAlbum, 'id' | 'spotifyId'>>, readonly tracks: ReadonlyArray<(
      Pick<Track, 'id' | 'isrc' | 'name' | 'discNumber' | 'trackNumber' | 'durationMs' | 'previewUrl' | 'popularity'>
      & { readonly artworkL: Pick<Artwork, 'url' | 'width' | 'height'>, readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicTracks?: Maybe<ReadonlyArray<Pick<AppleMusicTrack, 'id' | 'name' | 'appleMusicId'>>>, readonly spotifyTracks?: Maybe<ReadonlyArray<Pick<SpotifyTrack, 'id' | 'name' | 'spotifyId'>>>, readonly itunesTracks?: Maybe<ReadonlyArray<Pick<AppleMusicTrack, 'id' | 'name' | 'appleMusicId'>>> }
    )> }
  )> };
...
export type AlbumsQuery = { readonly items: ReadonlyArray<(
    ...
    & { readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicAlbum?: Maybe<Pick<AppleMusicAlbum, 'id'>>, readonly itunesAlbum?: Maybe<Pick<AppleMusicAlbum, 'id'>>, readonly spotifyAlbum?: Maybe<Pick<SpotifyAlbum, 'id'>> }
  )> };
...
export type PlaylistQuery = { readonly playlist?: Maybe<(
    Pick<Playlist, 'id' | 'name' | 'description' | 'isMine' | 'publicType' | 'createdAt' | 'updatedAt'>
    & { readonly track?: Maybe<(
      Pick<Track, 'id'>
      & { readonly artworkL: Pick<Artwork, 'url' | 'width' | 'height'> }
    )>, readonly author?: Maybe<Pick<User, 'id' | 'name' | 'username'>>, readonly items: ReadonlyArray<(
      Pick<PlaylistItem, 'trackNumber'>
      & { readonly track: (
        Pick<Track, 'id' | 'isrc' | 'name' | 'discNumber' | 'trackNumber' | 'durationMs' | 'previewUrl' | 'popularity'>
        & { readonly artworkM: Pick<Artwork, 'url' | 'width' | 'height'>, readonly appleMusicTracks?: Maybe<ReadonlyArray<Pick<AppleMusicTrack, 'id' | 'name' | 'appleMusicId'>>>, readonly spotifyTracks?: Maybe<ReadonlyArray<Pick<SpotifyTrack, 'id' | 'name' | 'spotifyId'>>> }
      ) }
    )> }
  )> };
...
export type SelectPlaylistsQueryVariables = Exact<{
  cursor?: Maybe<CursorInputObject>;
  sort?: Maybe<PlaylistsSortInputObject>;
  conditions?: Maybe<PlaylistsConditionsInputObject>;
}>;
...
export type SelectPlaylistsQuery = { readonly playlists: ReadonlyArray<Pick<Playlist, 'id' | 'name'>> };

export type SpotifyLoginQueryVariables = Exact<{
  code?: Maybe<Scalars['String']>;
}>;


export type SpotifyLoginQuery = Pick<Query, 'spotifyLogin'>;

export type SpotifyLogoutQueryVariables = Exact<{ [key: string]: never; }>;
...
export const SelectPlaylistsDocument: DocumentNode<SelectPlaylistsQuery, SelectPlaylistsQueryVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SelectPlaylists"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cursor"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"CursorInputObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"PlaylistsSortInputObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conditions"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"PlaylistsConditionsInputObject"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"playlists"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"cursor"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cursor"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}},{"kind":"Argument","name":{"kind":"Name","value":"conditions"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conditions"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]};
